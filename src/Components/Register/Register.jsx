...
const submit = async ()=>{
  const url = "https://auth-cuhd.onrender.com/register";
  try{
  ...
  return (
      ...
      <div>
        <form >
          ...
          <input id='lastname' value={lastname} onChange = {e=>setlastname(e.target.value)}type='text'/><br/>
          <label htmlFor='email'>email</label><br/>
          <input id='email' value={email} onChange={e=>setemail(e.target.value)} type='text'/><br/>
